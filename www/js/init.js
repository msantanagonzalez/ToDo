...
(function($) {
		...
		plugins: {
			layers: {
				...
				sidePanelAdmin: {
					...
					height: '100%',
					hidden: true,
					html: '<div data-action="moveElement" data-args="sidebarAdmin"></div>',
					orientation: 'vertical',
					position: 'top-left',
					side: 'left',
					width: 260
				...
				titleBarAdmin: {
					breakpoints: ['narrower', 'mobile'],
					height: 44,
					html: '<span class="toggle" data-action="toggleLayer" data-args="sidePanelAdmin" </span><span class="title" data-action="copyText" data-args="header"></span>',
					position: 'top-left',
					side: 'top',
					width: '100%'
				}
	...
	$(function() {
		...
		// Sidebar height hack.
			var $sc = $('#sidebar, #sidebarAdmin, #content'), tid;
