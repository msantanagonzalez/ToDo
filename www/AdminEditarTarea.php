									...
									<header> <p> <div>
									  <h1 id="logo"><a>- DETALLES TAREA -</a></h1>
										...
										<!--INICIO TABLA-->
                                            ...
                                            <tr>
                                            	<td>TÍTULO:</td>
                                            	<td><form ><input type="text"  class="text" placeholder="Título de la tarea..."/></form></td>
                                            	<td>PRIORIDAD:</td>
                                                <td><form>
                                                	<select >
                                            ...
                                            <tr>
                                               	<th colspan="4"><a href="adminDetallesTarea.html"><input type="submit" value="GUARDAR +"></a></th>
                                            </tr>
                                            </table>
                                      	<!-- FIN TABLA -->
									</p>	
