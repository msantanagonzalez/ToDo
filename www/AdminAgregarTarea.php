			...
			<div id="wrapper">
				...
				<!-- Content -->
					<div id="content">
						<div class="inner">
							<!--INICIO SECCIÓN-->
									<header> <p> <div> <h1 id="logo"><a>- AGREGAR TAREA -</a></h1> </div></p></header>
										<!--INICIO TABLA-->
                                        	<br>
                                            ...
                                            <tr>
                                            	<td>TÍTULO:</td>
                                            	<td><form ><input type="text" autofocus required class="text" placeholder="Título de la tarea..."/></form></td>
                                            	<td>PRIORIDAD:</td>
                                                <td><form>
                                            ...
                                            <tr>
                                            	<td>NOTAS:</td>
                                            	<td colspan="3"><form ><input type="text" class="text" placeholder="Apartado para notas..."/>
                                                </form></td>
                                            </tr>
                                            <tr>
                                            	<td>Fecha Inicio:</td>
                                            ...
                                            <tr>
                                               	<th colspan="4"><a href="adminGestorTareas.html"><input type="submit" value="GUARDAR +"></a></th>
                                            </tr>
                                            </table>
                                      	<!-- FIN TABLA -->
									</p>	
