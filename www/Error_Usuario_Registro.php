				...
				<div class="inner" align="center">    
					<h1 id="header" style="width:75%"><a>- REGISTRO -</a></h1> <br>  
                     		<form id="Registro" onsubmit="return Registro_Password()" action="php/Autenticar.php" method="post" style="width:65%" >
                            	<br> <input type="text" placeholder="¡¡¡ERROR-YA EXISTE ESTE USUARIO!!!" required autofocus/ name="Login_Usuario"> <br>
                           		<input type="text" placeholder="CORREO ELECTR&Oacute;NICO..." required/ name="Correo_Usuario"> <br>
